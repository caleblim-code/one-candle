        ...
        <div className={s.container}>
          <div className={s.footerGrid}>
            ...
            <div>
              ...
              <div className={s.footerLinks}><Link href="/contact">Contact</Link><Link href="/terms">Terms of Service</Link><Link href="/privacy">Privacy Policy</Link></div>
            </div>
            <div>
              <h4 className={s.footerColTitle}>Resources</h4>
              <div className={s.footerLinks}><Link href="/contact">Help Center</Link><a href="#features">Features</a><a href="#analytics">Analytics</a><a href="#pricing">Pricing</a></div>
            </div>
          </div>
          <div className={s.footerBottom}>
            <p>&copy; 2026 OneCandle. All rights reserved. · <Link href="/terms" style={{ color: 'inherit' }}>Terms</Link> · <Link href="/privacy" style={{ color: 'inherit' }}>Privacy</Link></p>
